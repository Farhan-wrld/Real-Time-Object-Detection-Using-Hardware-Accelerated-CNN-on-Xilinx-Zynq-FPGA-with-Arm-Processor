...
HD_PWD='C:/Users/Admin/Desktop/Bharat_ARM_Challenge/zynq_cnn_basek/zynq_cnn_basek.runs/system_axi_mem_intercon_imp_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_mem_intercon_imp_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_mem_intercon_imp_xbar_2.tcl

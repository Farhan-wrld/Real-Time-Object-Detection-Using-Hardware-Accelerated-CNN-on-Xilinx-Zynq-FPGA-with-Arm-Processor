...
HD_PWD='C:/Users/Admin/Desktop/Bharat_ARM_Challenge/zynq_cnn_basek/zynq_cnn_basek.runs/system_conv2d_0_10_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_conv2d_0_10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_conv2d_0_10.tcl

set moduleName conv2d_Pipeline_VITIS_LOOP_86_12_VITIS_LOOP_87_13_VITIS_LOOP_91_14_VITIS_LOOP_92
set isTopModule 0
...
set cdfgNum 9
set C_modelName {conv2d_Pipeline_VITIS_LOOP_86_12_VITIS_LOOP_87_13_VITIS_LOOP_91_14_VITIS_LOOP_92}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict pool1_out { MEM_WIDTH 32 MEM_SIZE 5408 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict conv2_out { MEM_WIDTH 32 MEM_SIZE 4224 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict conv2_out_1 { MEM_WIDTH 32 MEM_SIZE 4224 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ sum_11 float 32 regular  }
	{ gmem1 int 32 regular {axi_master 0}  }
	{ phi_mul182 int 8 regular  }
	{ pool1_out float 32 regular {array 1352 { 1 3 } 1 1 }  }
	{ sext_ln86 int 62 regular  }
	{ conv2_out float 32 regular {array 1056 { 0 3 } 0 1 }  }
	{ conv2_out_1 float 32 regular {array 1056 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "sum_11", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "phi_mul182", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "pool1_out", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln86", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "conv2_out", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "conv2_out_1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sum_11 sc_in sc_lv 32 signal 0 } 
	...
	{ phi_mul182 sc_in sc_lv 8 signal 2 } 
	{ pool1_out_address0 sc_out sc_lv 11 signal 3 } 
	{ pool1_out_ce0 sc_out sc_logic 1 signal 3 } 
	{ pool1_out_q0 sc_in sc_lv 32 signal 3 } 
	{ sext_ln86 sc_in sc_lv 62 signal 4 } 
	{ conv2_out_address0 sc_out sc_lv 11 signal 5 } 
	{ conv2_out_ce0 sc_out sc_logic 1 signal 5 } 
	{ conv2_out_we0 sc_out sc_logic 1 signal 5 } 
	{ conv2_out_d0 sc_out sc_lv 32 signal 5 } 
	{ conv2_out_1_address0 sc_out sc_lv 11 signal 6 } 
	{ conv2_out_1_ce0 sc_out sc_logic 1 signal 6 } 
	{ conv2_out_1_we0 sc_out sc_logic 1 signal 6 } 
	{ conv2_out_1_d0 sc_out sc_lv 32 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_11", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_11", "role": "default" }} , 
 	...
 	{ "name": "phi_mul182", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "phi_mul182", "role": "default" }} , 
 	...
 	{ "name": "pool1_out_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "pool1_out", "role": "q0" }} , 
 	...
 	{ "name": "conv2_out_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "conv2_out", "role": "d0" }} , 
 	...
 	{ "name": "conv2_out_1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "conv2_out_1", "role": "d0" }} , 
...
set ArgLastReadFirstWriteLatency {
	conv2d_Pipeline_VITIS_LOOP_86_12_VITIS_LOOP_87_13_VITIS_LOOP_91_14_VITIS_LOOP_92 {
		...
		pool1_out {Type I LastRead 8 FirstWrite -1}
		sext_ln86 {Type I LastRead 0 FirstWrite -1}
		conv2_out {Type O LastRead -1 FirstWrite 24}
		conv2_out_1 {Type O LastRead -1 FirstWrite 24}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "52291", "Max" : "52291"}
...
set Spec2ImplPortList { 
	sum_11 { ap_none {  { sum_11 in_data 0 32 } } }
	...
	phi_mul182 { ap_none {  { phi_mul182 in_data 0 8 } } }
	pool1_out { ap_memory {  { pool1_out_address0 mem_address 1 11 }  { pool1_out_ce0 mem_ce 1 1 }  { pool1_out_q0 mem_dout 0 32 } } }
	sext_ln86 { ap_none {  { sext_ln86 in_data 0 62 } } }
	conv2_out { ap_memory {  { conv2_out_address0 mem_address 1 11 }  { conv2_out_ce0 mem_ce 1 1 }  { conv2_out_we0 mem_we 1 1 }  { conv2_out_d0 mem_din 1 32 } } }
	conv2_out_1 { ap_memory {  { conv2_out_1_address0 mem_address 1 11 }  { conv2_out_1_ce0 mem_ce 1 1 }  { conv2_out_1_we0 mem_we 1 1 }  { conv2_out_1_d0 mem_din 1 32 } } }
}

...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename pool1_out \
    op interface \
    ports { pool1_out_address0 { O 11 vector } pool1_out_ce0 { O 1 bit } pool1_out_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename conv2_out \
    op interface \
    ports { conv2_out_address0 { O 11 vector } conv2_out_ce0 { O 1 bit } conv2_out_we0 { O 1 bit } conv2_out_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv2_out_1_address0 { O 11 vector } conv2_out_1_ce0 { O 1 bit } conv2_out_1_we0 { O 1 bit } conv2_out_1_d0 { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_phi_mul182 \
    op interface \
    ports { phi_mul182 { I 8 vector } } \
} "
}

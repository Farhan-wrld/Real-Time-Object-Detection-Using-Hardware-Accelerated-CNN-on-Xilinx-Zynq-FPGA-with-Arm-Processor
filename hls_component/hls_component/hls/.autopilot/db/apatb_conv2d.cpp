...
#define AUTOTB_TVOUT_input_r "../tv/cdatafile/c.conv2d.autotvout_input_r.dat"
#define AUTOTB_TVIN_weights "../tv/cdatafile/c.conv2d.autotvin_weights.dat"
#define AUTOTB_TVOUT_weights "../tv/cdatafile/c.conv2d.autotvout_weights.dat"
...
#define AUTOTB_TVIN_gmem0 "../tv/cdatafile/c.conv2d.autotvin_gmem0.dat"
#define AUTOTB_TVOUT_gmem0 "../tv/cdatafile/c.conv2d.autotvout_gmem0.dat"
#define AUTOTB_TVIN_gmem1 "../tv/cdatafile/c.conv2d.autotvin_gmem1.dat"
#define AUTOTB_TVOUT_gmem1 "../tv/cdatafile/c.conv2d.autotvout_gmem1.dat"
#define AUTOTB_TVIN_gmem2 "../tv/cdatafile/c.conv2d.autotvin_gmem2.dat"
#define AUTOTB_TVOUT_gmem2 "../tv/cdatafile/c.conv2d.autotvout_gmem2.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem0 "../tv/rtldatafile/rtl.conv2d.autotvout_gmem0.dat"
#define AUTOTB_TVOUT_PC_gmem1 "../tv/rtldatafile/rtl.conv2d.autotvout_gmem1.dat"
#define AUTOTB_TVOUT_PC_gmem2 "../tv/rtldatafile/rtl.conv2d.autotvout_gmem2.dat"
...
extern "C"
void conv2d_hw_stub_wrapper(void*, void*, void*, void*);

extern "C"
void apatb_conv2d_hw(void* __xlx_apatb_param_input_r, void* __xlx_apatb_param_weights, void* __xlx_apatb_param_bias, void* __xlx_apatb_param_output_r)
{
  ...
  port5.param = { __xlx_apatb_param_weights, __xlx_apatb_param_bias };
  port5.mname = { "weights", "bias" };
  port5.nbytes = { 20896, 136 };
  for (size_t i = 0; i < port5.nbytes.size(); ++i) {
    if (port5.nbytes[i] > port5.max_nbytes[i]) {
      port5.max_nbytes[i] = port5.nbytes[i];
    }
  }
  port5.offset.clear();
  for (size_t off = 0, i = 0; i < port5.nbytes.size(); ++i) {
    port5.offset.push_back(off);
    off += hls::sim::divide_ceil(port5.max_nbytes[i], port5.asize);
  }
  __xlx_offset_byte_param_weights = port5.offset[0]*4;
  __xlx_offset_byte_param_bias = port5.offset[1]*4;
  ...
  try {
    ...
    conv2d_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_weights, __xlx_apatb_param_bias, __xlx_apatb_param_output_r);

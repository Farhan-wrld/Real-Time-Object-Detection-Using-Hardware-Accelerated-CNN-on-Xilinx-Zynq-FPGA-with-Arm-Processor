...
# 2 "<built-in>" 2
# 1 "conv2d.cpp" 2
# 1 "C:/AMDDesignTools/2025.2/Vitis/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\math.h" 1 3
# 36 "C:/AMDDesignTools/2025.2/Vitis/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\math.h" 3
...
# 37 "C:/AMDDesignTools/2025.2/Vitis/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\math.h" 2 3
...
__attribute__((sdx_kernel("conv2d", 0))) void conv2d(
    float *input,
    float *weights,
    float *bias,
    float *output
...
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=conv2d
# 8 "conv2d.cpp"
...
#pragma HLS INTERFACE s_axilite port=return
    ...
    VITIS_LOOP_37_1: for (int oc = 0; oc < 8; oc++) {
        VITIS_LOOP_38_2: for (int i = 0; i < 26; i++) {
            VITIS_LOOP_39_3: for (int j = 0; j < 26; j++) {

                float sum = bias[oc];

                VITIS_LOOP_43_4: for (int ki = 0; ki < 3; ki++) {
                    VITIS_LOOP_44_5: for (int kj = 0; kj < 3; kj++) {
    ...
    VITIS_LOOP_60_6: for (int c = 0; c < 8; c++) {
        VITIS_LOOP_61_7: for (int i = 0; i < 13; i++) {
            VITIS_LOOP_62_8: for (int j = 0; j < 13; j++) {

                float m = conv1_out[c][2*i][2*j];

                VITIS_LOOP_66_9: for (int pi=0; pi<2; pi++)
                    VITIS_LOOP_67_10: for (int pj=0; pj<2; pj++)
    ...
    VITIS_LOOP_85_11: for (int oc = 0; oc < 16; oc++) {
        VITIS_LOOP_86_12: for (int i = 0; i < 11; i++) {
            VITIS_LOOP_87_13: for (int j = 0; j < 11; j++) {

                float sum = bias[conv2_b_off + oc];

                VITIS_LOOP_91_14: for (int ic = 0; ic < 8; ic++) {
                    VITIS_LOOP_92_15: for (int ki = 0; ki < 3; ki++) {
                        VITIS_LOOP_93_16: for (int kj = 0; kj < 3; kj++) {
    ...
    VITIS_LOOP_116_17: for (int c = 0; c < 16; c++) {
        VITIS_LOOP_117_18: for (int i = 0; i < 5; i++) {
            VITIS_LOOP_118_19: for (int j = 0; j < 5; j++) {

                float m = conv2_out[c][2*i][2*j];

                VITIS_LOOP_122_20: for (int pi=0; pi<2; pi++)
                    VITIS_LOOP_123_21: for (int pj=0; pj<2; pj++)
    ...
    int idx = 0;
    VITIS_LOOP_137_22: for (int c=0;c<16;c++)
        VITIS_LOOP_138_23: for (int i=0;i<5;i++)
            VITIS_LOOP_139_24: for (int j=0;j<5;j++)
    ...
    VITIS_LOOP_151_25: for (int o=0; o<10; o++) {

        float sum = bias[fc_b_off + o];

        VITIS_LOOP_155_26: for (int i=0;i<400;i++)

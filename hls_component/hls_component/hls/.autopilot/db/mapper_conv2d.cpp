...
using hls::sim::Byte;
extern "C" void conv2d(Byte<4>*, Byte<4>*, Byte<4>*, int, int, int, int);
extern "C" void apatb_conv2d_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_weights, volatile void * __xlx_apatb_param_bias, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_input_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_input_r)[i]);
  ...
  // Collect __xlx_weights_bias__tmp_vec
std::vector<Byte<4>> __xlx_weights_bias__tmp_vec;
for (size_t i = 0; i < 5224; ++i){
__xlx_weights_bias__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_weights)[i]);
}
  int __xlx_size_param_weights = 5224;
  int __xlx_offset_param_weights = 0;
  int __xlx_offset_byte_param_weights = 0*4;
for (size_t i = 0; i < 34; ++i){
__xlx_weights_bias__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_bias)[i]);
}
  int __xlx_size_param_bias = 34;
  int __xlx_offset_param_bias = 5224;
  int __xlx_offset_byte_param_bias = 5224*4;
...
__xlx_output_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  // DUT call
  conv2d(__xlx_input_r__tmp_vec.data(), __xlx_weights_bias__tmp_vec.data(), __xlx_output_r__tmp_vec.data(), __xlx_offset_byte_param_input_r, __xlx_offset_byte_param_weights, __xlx_offset_byte_param_bias, __xlx_offset_byte_param_output_r);
...
((Byte<4>*)__xlx_apatb_param_weights)[i] = __xlx_weights_bias__tmp_vec[__xlx_offset_param_weights+i];
}
// print __xlx_apatb_param_bias
for (size_t i = 0; i < __xlx_size_param_bias; ++i) {
((Byte<4>*)__xlx_apatb_param_bias)[i] = __xlx_weights_bias__tmp_vec[__xlx_offset_param_bias+i];
}

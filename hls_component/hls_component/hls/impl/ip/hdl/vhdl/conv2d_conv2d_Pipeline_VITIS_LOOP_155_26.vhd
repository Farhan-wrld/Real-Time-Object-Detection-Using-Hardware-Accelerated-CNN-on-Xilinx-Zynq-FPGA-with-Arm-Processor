...
entity conv2d_conv2d_Pipeline_VITIS_LOOP_155_26 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of conv2d_conv2d_Pipeline_VITIS_LOOP_155_26 is 
...
attribute shreg_extract : string;
    ...
    signal i_1_reg_232 : STD_LOGIC_VECTOR (8 downto 0);
    signal icmp_ln155_fu_155_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln155_reg_238_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln155_reg_238_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal gmem1_addr_reg_242 : STD_LOGIC_VECTOR (63 downto 0);
    signal fc_in_load_reg_253 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal gmem1_addr_read_reg_258 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage3_11001_grp2 : BOOLEAN;
    signal bitcast_ln156_fu_201_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal sum_11_reg_278 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state2_io_grp1 : BOOLEAN;
    signal zext_ln155_fu_197_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal sext_ln156_fu_177_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal add_ln155_fu_187_p2 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal zext_ln155_1_fu_161_p1 : STD_LOGIC_VECTOR (62 downto 0);
    signal sext_ln151_cast_fu_138_p1 : STD_LOGIC_VECTOR (62 downto 0);
    signal add_ln156_fu_165_p2 : STD_LOGIC_VECTOR (62 downto 0);
    signal zext_ln153_cast_fu_134_p1 : STD_LOGIC_VECTOR (62 downto 0);
    signal add_ln156_1_fu_171_p2 : STD_LOGIC_VECTOR (62 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln155_reg_238 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0_reg = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage5_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                sum_fu_68 <= sum_19;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001_grp0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_idle_pp0, ap_block_pp0_stage5_subdone, ap_block_pp0_stage1_subdone, ap_condition_exit_pp0_iter2_stage1, ap_idle_pp0_0to1, ap_block_pp0_stage3_subdone, ap_block_pp0_stage0_subdone, ap_block_pp0_stage2_subdone, ap_block_pp0_stage4_subdone)
    begin
        case ap_CS_fsm is
    ...
    add_ln155_fu_187_p2 <= std_logic_vector(unsigned(i_1_reg_232) + unsigned(ap_const_lv9_1));
    add_ln156_1_fu_171_p2 <= std_logic_vector(unsigned(add_ln156_fu_165_p2) + unsigned(zext_ln153_cast_fu_134_p1));
    add_ln156_fu_165_p2 <= std_logic_vector(unsigned(zext_ln155_1_fu_161_p1) + unsigned(sext_ln151_cast_fu_138_p1));
    ...
    ap_block_pp0_stage3_11001_assign_proc : process(ap_enable_reg_pp0_iter1, m_axi_gmem1_0_RVALID)
    begin
                ap_block_pp0_stage3_11001 <= ((m_axi_gmem1_0_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;

        ap_block_pp0_stage3_11001_grp0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage3_11001_grp2_assign_proc : process(ap_enable_reg_pp0_iter1, m_axi_gmem1_0_RVALID)
    begin
                ap_block_pp0_stage3_11001_grp2 <= ((m_axi_gmem1_0_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;

        ap_block_pp0_stage3_grp2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage3_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, m_axi_gmem1_0_RVALID)
    begin
                ap_block_pp0_stage3_subdone <= ((m_axi_gmem1_0_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;
    ...
    ap_block_state2_io_grp1_assign_proc : process(icmp_ln155_reg_238, m_axi_gmem1_0_ARREADY)
    begin
                ap_block_state2_io_grp1 <= ((m_axi_gmem1_0_ARREADY = ap_const_logic_0) and (icmp_ln155_reg_238 = ap_const_lv1_0));
    end process;


    ap_condition_exit_pp0_iter0_stage5_assign_proc : process(ap_CS_fsm_pp0_stage5, ap_block_pp0_stage5_subdone, ap_enable_reg_pp0_iter0_reg, icmp_ln155_reg_238)
    begin
        if (((icmp_ln155_reg_238 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0_reg = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage5_subdone) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then 
    ...
    ap_condition_exit_pp0_iter2_stage1_assign_proc : process(ap_enable_reg_pp0_iter2, ap_CS_fsm_pp0_stage1, icmp_ln155_reg_238_pp0_iter2_reg, ap_block_pp0_stage1_subdone)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1_subdone) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln155_reg_238_pp0_iter2_reg = ap_const_lv1_1))) then 
    ...
    bitcast_ln156_fu_201_p1 <= gmem1_addr_read_reg_258;
    fc_in_address0 <= zext_ln155_fu_197_p1(9 - 1 downto 0);
    fc_in_ce0 <= fc_in_ce0_local;

    fc_in_ce0_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    gmem1_blk_n_AR_assign_proc : process(ap_enable_reg_pp0_iter0_reg, icmp_ln155_reg_238, m_axi_gmem1_0_ARREADY, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_grp1)
    begin
        if (((icmp_ln155_reg_238 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0_reg = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    gmem1_blk_n_R_assign_proc : process(ap_enable_reg_pp0_iter1, m_axi_gmem1_0_RVALID, ap_CS_fsm_pp0_stage3, ap_block_pp0_stage3_grp2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage3_grp2) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
    ...
    grp_fu_1035_p_ce <= grp_fu_126_ce;
    grp_fu_1035_p_din0 <= sum_fu_68;
    grp_fu_1035_p_din1 <= mul1_reg_268;
    grp_fu_1035_p_opcode <= ap_const_lv2_0;
    grp_fu_1039_p_ce <= grp_fu_130_ce;
    grp_fu_1039_p_din0 <= fc_in_load_reg_253;
    grp_fu_1039_p_din1 <= bitcast_ln156_fu_201_p1;

    grp_fu_126_ce_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_CS_fsm_pp0_stage5, ap_CS_fsm_pp0_stage3, ap_block_pp0_stage0_11001, ap_CS_fsm_pp0_stage4, ap_block_pp0_stage4_11001, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2_11001, ap_block_pp0_stage5_11001, ap_block_pp0_stage3_11001_grp0, ap_block_pp0_stage3_subdone_grp0_done_reg)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage3_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage3_11001_grp0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3)) or ((ap_const_boolean_0 = ap_block_pp0_stage5_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5)) or ((ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2)) or ((ap_const_boolean_0 = ap_block_pp0_stage4_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage4)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    grp_fu_130_ce_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_CS_fsm_pp0_stage5, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage0_11001, ap_block_pp0_stage1_11001_grp0, ap_block_pp0_stage1_subdone_grp0_done_reg, ap_CS_fsm_pp0_stage4, ap_block_pp0_stage4_11001, ap_block_pp0_stage5_11001)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage5_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5)) or ((ap_const_boolean_0 = ap_block_pp0_stage4_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage4)) or ((ap_const_boolean_0 = ap_block_pp0_stage1_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001_grp0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    icmp_ln155_fu_155_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv9_190) else "0";
    m_axi_gmem1_0_ARADDR <= gmem1_addr_reg_242;
    ...
    m_axi_gmem1_0_ARVALID_assign_proc : process(ap_enable_reg_pp0_iter0_reg, icmp_ln155_reg_238, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_11001_grp1)
    begin
        if (((icmp_ln155_reg_238 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0_reg = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    m_axi_gmem1_0_RREADY_assign_proc : process(ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage3, ap_block_pp0_stage3_11001_grp2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage3_11001_grp2) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
    ...
    m_axi_gmem1_0_WVALID <= ap_const_logic_0;
        sext_ln151_cast_fu_138_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln151),63));

        sext_ln156_fu_177_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln156_1_fu_171_p2),64));

    sum_15_out <= sum_fu_68;

    sum_15_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln155_reg_238_pp0_iter2_reg, ap_block_pp0_stage1_11001_grp0, ap_block_pp0_stage1_subdone_grp0_done_reg, ap_loop_exit_ready_pp0_iter2_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001_grp0) and (ap_loop_exit_ready_pp0_iter2_reg = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln155_reg_238_pp0_iter2_reg = ap_const_lv1_1))) then 
    ...
    zext_ln153_cast_fu_134_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln153),63));
    zext_ln155_1_fu_161_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_1),63));
    zext_ln155_fu_197_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_1_reg_232),64));
end behav;

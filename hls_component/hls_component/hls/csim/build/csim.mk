...
HLS_SOURCES = ../../../../conv2d_tb.cpp ../../../../conv2d.cpp
...
$(ObjDir)/conv2d_tb.o: ../../../../conv2d_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../conv2d_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/conv2d_tb.d

$(ObjDir)/conv2d.o: ../../../../conv2d.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../conv2d.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=conv2d $(IFLAG) $(DFLAG) $< -o $@ ; \
